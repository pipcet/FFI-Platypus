...
our @CARP_NOT = qw( FFI::Platypus::Impl::LibffiPerl::Declare );
...
sub type
{
  ...
  || $name =~ /^string(_rw|_ro|\s+rw|\s+ro|\s*\([0-9]+\))$/)
  {
    ...
    $self->{types}->{$name} ||= FFI::Platypus::Impl::LibffiPerl::Type->new($name, $self);
  }
  else
  {
    my $basic = $name;
    ...
    $self->{types}->{$name} = $self->{types}->{$type_map->{$basic}.$extra} ||= FFI::Platypus::Impl::LibffiPerl::Type->new($type_map->{$basic}.$extra, $self);
  }
...
sub constant_type
{
  ...
  $self->{types}->{$name} = FFI::Platypus::Impl::LibffiPerl::Type::Constant->_new_constant(
    \@types,
    $size,
    $value,
  );
...
sub custom_type
{
  ...
  $self->{types}->{$name} = FFI::Platypus::Impl::LibffiPerl::Type::CustomPerl->_new_custom_perl(
    \@types,
    $size,
    $cb->{perl_to_native},
    $cb->{native_to_perl},
...
sub struct_type
{
  ...
  $self->{types}->{$name} = FFI::Platypus::Impl::LibffiPerl::Type->_new_struct_type(
    \@children
  );
...
sub load_custom_type
{
  ...
  $name = "FFI::Platypus::Impl::LibffiPerl::Type$name" if $name =~ /^::/;
  $name = "FFI::Platypus::Impl::LibffiPerl::Type::$name" unless $name =~ /::/;
...
{
  my($self) = @_;
  $self = $self->new unless ref $self && eval { $self->isa('FFI::Platypus::Impl::LibffiPerl') };
...
sub function
{
  ...
  FFI::Platypus::Impl::LibffiPerl::Function->new($self, $address, $self->{abi}, $ret, @args);
}
...
sub attach
{
  ...
  if(defined $function)
  {
    ...
    if($wrapper)
    {
      $attach_name = "FFI::Platypus::Impl::LibffiPerl::Inner::xsub$inner_counter";
      $inner_counter++;
    }
...
{
  my($self, $coderef) = @_;
  FFI::Platypus::Impl::LibffiPerl::Closure->new($coderef);
}
...
package FFI::Platypus::Impl::LibffiPerl::Function;
...
package FFI::Platypus::Impl::LibffiPerl::Closure;
...
sub add_data
{
  ...
  $self->{cbdata}{refaddr $type} = {
    closure_data => bless(\$payload, 'FFI::Platypus::Impl::LibffiPerl::ClosureData'),
    type => $type,
  };
...
package FFI::Platypus::Impl::LibffiPerl::ClosureData;
...
package FFI::Platypus::Impl::LibffiPerl::Type::Pointer;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::Array;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::Closure;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';
...
package FFI::Platypus::Impl::LibffiPerl::Type::Constant;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::CustomPerl;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';
...
package FFI::Platypus::Impl::LibffiPerl::Type::Record;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::Struct;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::ExoticFloat;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';

package FFI::Platypus::Impl::LibffiPerl::Type::FFI;
use parent -norequire, 'FFI::Platypus::Impl::LibffiPerl::Type';
use Carp qw(croak);
