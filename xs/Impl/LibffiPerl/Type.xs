MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type
...
_new(class, type, platypus_type, array_or_record_or_string_size, type_classname, rw)
    ...
    ffi_pl_ffiperl_string type_classname
    int rw
  PREINIT:
  ...
  CODE:
    ...
    {
      Newx(buffer, sizeof(ffi_pl_ffiperl_type) + sizeof(ffi_pl_ffiperl_type_extra_string), char);
      self = (ffi_pl_ffiperl_type*) buffer;
      self->hv = NULL;
      self->ffi_type = NULL;
    ...
    {
      Newx(self, 1, ffi_pl_ffiperl_type);
      self->hv = NULL;
      self->ffi_type = NULL;
    ...
    {
      Newx(buffer, sizeof(ffi_pl_ffiperl_type) + sizeof(ffi_pl_ffiperl_type_extra_array), char);
      self = (ffi_pl_ffiperl_type*) buffer;
      self->hv = NULL;
      self->ffi_type = NULL;
    ...
    {
      Newx(buffer, sizeof(ffi_pl_ffiperl_type) + sizeof(ffi_pl_ffiperl_type_extra_record), char);
      self = (ffi_pl_ffiperl_type*) buffer;
      self->hv = NULL;
      self->ffi_type = NULL;
    ...
    {
      self->ffi_type = ffi_pl_ffiperl_name_to_type(type);
...
_new_custom_perl(class, types, size, perl_to_native, native_to_perl, perl_to_native_post, in_argument_count, out_argument_count)
  ...
  PREINIT:
    ...
    ffi_pl_ffiperl_type *self;
    ffi_type *ffi_type;
    ffi_pl_ffiperl_type_extra_custom_perl *custom;
  CODE:
    Newx(buffer, sizeof(ffi_pl_ffiperl_type) + sizeof(ffi_pl_ffiperl_type_extra_custom_perl), char);
    self = (ffi_pl_ffiperl_type*) buffer;
    self->hv = newHV();
    self->ffi_type = NULL;
...
_new_struct_type(class, types)
  ...
  CODE:
    ...
    for(i=0, j=0; i<perl_n; i++,j++)
    {
      ...
      j += ffi_pl_ffiperl_prepare_any(NULL, NULL, ffi_children+j, ffi_children+ffi_n, *svp);
      SPAGAIN;
    }
...
_new_closure(class, return_type_arg, ...)
  ...
  CODE:
    if (!sv_isobject(return_type_arg) ||
        !sv_derived_from(return_type_arg, "FFI::Platypus::Impl::LibffiPerl::Type::FFI")) {
    ...
    for(i=0; i<(items-2); i++)
    {
      arg = ST(2+i);
      if (!sv_isobject(arg) ||
          (!sv_derived_from(arg, "FFI::Platypus::Impl::LibffiPerl::Type::FFI") &&
	   !sv_derived_from(arg, "FFI::Platypus::Impl::LibffiPerl::Type::String"))) {
    ...
    for(i=0; i<(items-2);)
    {
      ...
      i += ffi_pl_ffiperl_prepare_any(NULL, NULL, ffi_argument_types+i, ffi_argument_types+items-2, arg);
      SPAGAIN;
    }
...
meta(self)
  ...
  PREINIT:
    HV *meta;
  CODE:
    meta = ffi_pl_ffiperl_get_type_meta(self);
...
sizeof(selfsv)
    SV *selfsv
  CODE:
    RETVAL = ffi_pl_ffiperl_sizeof(selfsv, SV2ffi_pl_ffiperl_type(selfsv));
  OUTPUT:
    RETVAL

void *
prepare_pointer(ffi)
    ffi_pl_ffiperl_type *ffi
  CODE:
    RETVAL = ffi_pl_ffiperl_prepare_generic;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::Array

void *
prepare_pointer(ffi)
    ffi_pl_ffiperl_type *ffi
  CODE:
    RETVAL = ffi_pl_ffiperl_prepare_array;
  OUTPUT:
    RETVAL
...
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_array;
  OUTPUT:
    RETVAL
...
perl_to_native_post_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_array_post;
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_native_to_perl_array;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::Closure

void *
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_closure;
  OUTPUT:
    RETVAL
...
perl_to_native_post_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_closure_post;
  OUTPUT:
    RETVAL
...
MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::Constant

void *
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_constant;
  OUTPUT:
    RETVAL
...
MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::CustomPerl

void *
prepare_pointer(ffi)
    ffi_pl_ffiperl_type *ffi
  CODE:
    RETVAL = ffi_pl_ffiperl_prepare_customperl;
  OUTPUT:
    RETVAL
...
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_customperl;
  OUTPUT:
    RETVAL
...
perl_to_native_post_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_custom_perl_post;
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_native_to_perl_customperl;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::ExoticFloat

void *
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_exoticfloat;
  OUTPUT:
    RETVAL
...
perl_to_native_post_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_exoticfloat_post;
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_native_to_perl_exoticfloat;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::Pointer

void *
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_ref;
  OUTPUT:
    RETVAL
...
perl_to_native_post_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_ref_post;
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_native_to_perl_pointer;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::Record

void *
perl_to_native_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_arguments_set_record;
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
    ffi_pl_ffiperl_type *self
  CODE:
    RETVAL = ffi_pl_ffiperl_native_to_perl_record;
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::String
...
perl_to_native_pointer(self)
  ...
  CODE:
    if(self->extra[0].string.platypus_string_type == FFI_PL_STRING_RW ||
      ...
      RETVAL = ffi_pl_ffiperl_arguments_set_perl_string_variable;
    } else {
      RETVAL = ffi_pl_ffiperl_arguments_set_perl_string;
    }
  OUTPUT:
    RETVAL
...
native_to_perl_pointer(self)
  ...
  CODE:
    if(self->extra[0].string.platypus_string_type == FFI_PL_STRING_RW ||
       self->extra[0].string.platypus_string_type == FFI_PL_STRING_RO) {
      RETVAL = ffi_pl_ffiperl_native_to_perl_string_variable;
    } else {
      RETVAL = ffi_pl_ffiperl_native_to_perl_string;
    }
  OUTPUT:
    RETVAL

MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::FFI

void *
prepare_pointer(ffi)
    ffi_type *ffi
  CODE:
    RETVAL = ffi_pl_ffiperl_prepare_ffi;
  OUTPUT:
    RETVAL
...
perl_to_native_pointer(ffi)
  ...
  CODE:
    ...
    {
    case FFI_TYPE_VOID:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_void;
      break;
    case FFI_TYPE_UINT8:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_uint8;
      break;
    case FFI_TYPE_SINT8:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_sint8;
      break;
    case FFI_TYPE_UINT16:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_uint16;
      break;
    case FFI_TYPE_SINT16:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_sint16;
      break;
    case FFI_TYPE_UINT32:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_uint32;
      break;
    case FFI_TYPE_SINT32:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_sint32;
      break;
#ifdef HAVE_IV_IS_64
    case FFI_TYPE_UINT64:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_uint64;
      break;
    case FFI_TYPE_SINT64:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_sint64;
      break;
#else
    case FFI_TYPE_UINT64:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_uint64;
...
#endif
    case FFI_TYPE_FLOAT:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_float;
      break;
    case FFI_TYPE_DOUBLE:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_double;
      break;
    case FFI_TYPE_POINTER:
      RETVAL = ffi_pl_ffiperl_arguments_set_ffi_pointer;
      break;
    default:
...
native_to_perl_pointer(ffi)
  ...
  CODE:
    ...
    case FFI_TYPE_VOID:
      ...
      break;
    case FFI_TYPE_UINT8:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_uint8;
      break;
    case FFI_TYPE_SINT8:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_sint8;
      break;
    case FFI_TYPE_UINT16:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_uint16;
      break;
    case FFI_TYPE_SINT16:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_sint16;
      break;
    case FFI_TYPE_UINT32:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_uint32;
      break;
    case FFI_TYPE_SINT32:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_sint32;
      break;
#ifdef HAVE_IV_IS_64
    case FFI_TYPE_UINT64:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_uint64;
      break;
    case FFI_TYPE_SINT64:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_sint64;
      break;
#else
    case FFI_TYPE_UINT64:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_uint64;
...
#endif
    case FFI_TYPE_FLOAT:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_float;
      break;
    case FFI_TYPE_DOUBLE:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_double;
      break;
    case FFI_TYPE_POINTER:
      RETVAL = ffi_pl_ffiperl_native_to_perl_ffi_pointer;
      break;
    default:
      croak("argument type not supported (%d)", ffi->type);
      break;
...
MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::C
...
DESTROY(self_sv)
  ...
  PREINIT:
    ...
    ffi_pl_ffiperl_type *self;
  CODE:
    self = INT2PTR(ffi_pl_ffiperl_type *, SvIV((SV *)SvRV(self_sv)));
/* XXX
...
MODULE = FFI::Platypus::Impl::LibffiPerl PACKAGE = FFI::Platypus::Impl::LibffiPerl::Type::StringPointer
...
new(class, name)
    ...
    const char *name
  CODE:
    RETVAL = ffi_pl_ffiperl_name_to_type(name);
  OUTPUT:
    RETVAL
...
meta(self)
  ...
  PREINIT:
    HV *meta;
  CODE:
    meta = ffi_pl_ffiperl_ffi_get_type_meta(self);
    RETVAL = newRV_noinc((SV*)meta);
  OUTPUT:
    RETVAL
